...
public class Storytime1 implements Initializable{
    ...
    {
        testMethod.ResetAllPositions(2);
    ...
    public void PressAddYes(javafx.event.ActionEvent event) throws IOException
    {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                {
                    case 4:
                        System.out.println("Playing Storytime Dialogue 4 with Yes");
                        String s = "!vcc1=0!rst38#";
                        testMethod.SendInstructionToWeigl(s);
                        timer.schedule(new TimerTask() {
                            @Override
                            public void run() {
                                String s = "!vcc1=0!rst18#";
                                testMethod.SendInstructionToWeigl(s);
                            }
                        }, 1*1000);
                        tom4.setVisible(false);
